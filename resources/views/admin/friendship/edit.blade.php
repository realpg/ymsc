...
@section('content')
    <div class="page-container">
        <form class="form form-horizontal" method="post" id="form-friendship-edit">
            {{csrf_field()}}
            <div class="row cl hidden">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>id：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input id="id" name="id" type="text" class="input-text"
                           value="{{ isset($data['id']) ? $data['id'] : '' }}" placeholder="Friendship_id">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl" id="container">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    @if($data['picture'])
                        <img id="imagePrv" src="{{$data['picture'] }}" width="115" />
                    @else
                        <img id="imagePrv" src="{{ URL::asset('/img/upload.png') }}" width="115" />
                    @endif
        ...
        $(function () {
            ...
            $("#form-friendship-edit").validate({
                ...
                submitHandler: function (form) {
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/friendship/edit')}}",
