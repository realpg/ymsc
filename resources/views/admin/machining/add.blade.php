...
@section('content')
    <div class="page-container">
        <form class="form form-horizontal" method="post" id="form-machining-add">
            {{csrf_field()}}
        ...
        $(function () {
            ...
            $("#form-machining-add").validate({
                ...
                submitHandler: function (form) {
                    $(form).ajaxSubmit({
                        type: 'POST',
                        url: "{{ URL::asset('/admin/machining/add')}}",
