        ...
        <form class="form form-horizontal" method="post" id="form-menu-edit">
            ...
            @if(!isset($data['name'])||$data['menu_id']!=0)
                ...
                <div class="row cl" id="container">
                    <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>图标上传：</label>
                    <div class="formControls col-xs-8 col-sm-9">
                        @if($data['picture'])
                            <img id="imagePrv" src="{{$data['picture'] }}" width="100" height="100" />
                        @else
                            <img id="imagePrv" src="{{ URL::asset('/img/upload.png') }}" width="100" height="100" />
                        @endif
                        <span class="c-red">*请上传200*200尺寸的图标</span>
