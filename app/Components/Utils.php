...
//    const ALIPAY_RETRUN_URL = "http://ymsc.isart.me/order/pay/success";   //支付宝支付成功后跳转的页面
    const ALIPAY_NOTIFY_URL = "/api/aliNotify/";   //支付宝回调链接
    const ALIPAY_RETRUN_URL = "/order/pay/success";   //支付宝支付成功后跳转的页面
    ...
    const FAIL_SIGNIN_WECHAT = '微信登录失败,您可以选择用账号密码登录';   //微信登录失败

    //微信登录
    const WECHAT_LOGIN_APP_ID='wxe6deb72d8381e0f2';
    const WECHAT_LOGIN_APP_SECRET='81c5ffe6e266fa69a5d357e31ecfcc64';
