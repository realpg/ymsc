...
class Utils
{
    ...
    const ALIPAY_NOTIFY_URL = "http://localhost/ymsc/public/api/order/aliNotify";   //支付宝回调链接
//    const ALIPAY_RETRUN_URL = "http://localhost/ymsc/public/order/success";   //支付宝支付成功后跳转的页面
    const ALIPAY_RETRUN_URL = "http://localhost/ymsc/public/api/order/aliReturn";   //支付宝支付成功后跳转的页面
